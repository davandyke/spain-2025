...
::: {layout-ncol=2}
![](images/sep29-lounge.jpeg){fig-cap="ORD lounge fuel-up" alt="Plate of food with cava in airport lounge"}
![](images/sep29-train.jpeg){fig-cap="Chamartín station" alt="Crowds boarding trains in Madrid"}
:::
