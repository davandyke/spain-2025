...
- Check-in: **Albergue O Durmiñento** (Confirmation no. 6103.134.828).  
...
- **Day 7 (Oct 4):** O Pedrouzo → Santiago (~20 km)  
  ...
  - Check-in: **Pensión Rua Nova** (Rúa Nova, 4, Santiago de Compostela; Confirmation no. 6216.069.981).  
...
- Overnight: Finisterre (hotel or albergue in town).

### Day 10 – Tue Oct 7
- Morning in Finisterre — coffee in town or short coastal stroll.  
- Midday bus back to Santiago (~2.5 hrs).  
- Connect onward to Madrid in the afternoon (~3 hrs AVE train, ~1 hr flight).  
...
- Book Santiago (Oct 4–7) and Madrid (Oct 6–7) hotels.   
